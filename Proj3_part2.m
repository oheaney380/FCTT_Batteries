...
for i = 1:n_SoC
    ...
    for j = 1:n_pulses
        ...
        if j == n_pulses
            ...
            I = CurrentA(pulse_locs(pulse_idx)-10:pulse_locs(pulse_idx)+5000);
            
            params{i,j} = lsqcurvefit(@ECN_model_timebase,[R0_init,R1_init,C1_init,SoC(i)],...
                Times(pulse_locs(pulse_idx)-10:pulse_locs(pulse_idx)+5000),...
                VoltageV1(pulse_locs(pulse_idx)-10:pulse_locs(pulse_idx)+5000),...
                [10e-3,10e-3,1e3,SoC(i)],[100e-3,100e-3,inf,SoC(i)]);
        else
            
            I = VoltageV1(pulse_locs(pulse_idx)-10:pulse_locs(pulse_idx+1)-30);
            
            params{i,j} = lsqcurvefit(@ECN_model_timebase,[R0_init,R1_init,C1_init,SoC(i)],...
                Times(pulse_locs(pulse_idx)-10:pulse_locs(pulse_idx+1)-30) ,...
                VoltageV1(pulse_locs(pulse_idx)-10:pulse_locs(pulse_idx+1)-30),...
                [10e-3,10e-3,1e3,SoC(i)],[100e-3,100e-3,inf,SoC(i)]);
        end
